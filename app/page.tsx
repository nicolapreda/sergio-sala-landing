  ...
  return (
    <main className="min-h-screen text-white overflow-x-hidden font-sans selection:bg-brand-red selection:text-white">
      ...
      <section className="relative pt-40 pb-20 md:pt-52 md:pb-32 px-6 overflow-hidden">
         {/* Background Effects */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-red/5 blur-[120px] rounded-full -z-10 animate-pulse" />
        ...
        <div className="container mx-auto max-w-5xl text-center space-y-8">
          ...
          >            
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tighter">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold via-yellow-200 to-brand-gold italic pr-2 drop-shadow-lg">SENZA BALLARE</span> 💃🚫 <br />
              SU TIKTOK.
            </h1>
      ...
      {/* PROBLEM SECTION */}
      <section className="py-24 bg-brand-gray/50 border-y border-white/5 backdrop-blur-sm">
      ...
      {/* SOLUTION / METHOD */}
      {/* CLIENTS / METHOD */}
      <section id="metodo" className="py-24 px-6 relative overflow-hidden bg-brand-dark">
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4 pt-8">
                     <div className="h-64 rounded-2xl bg-gray-800 border-2 border-brand-gold/20 overflow-hidden relative group hover:border-brand-gold/50 transition-colors">
                        ...
                        <span className="absolute bottom-4 left-4 text-white z-20 font-bold">Food Porn 🍔</span>
                     </div>
            ...
            <div className="space-y-8">
               ...
               <div className="space-y-6 text-lg text-gray-300">
                  <div className="flex items-start gap-3">
                     ...
                     <p>Contenuti pensati per <span className="text-white font-bold">far venire fame</span></p>
                  </div>
                  <div className="flex items-start gap-3">
                     <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shadow-[0_0_10px_orange]" />
                     <p>Per raccontare il tuo locale nel <span className="text-white font-bold">modo giusto</span></p>
                  </div>
                  <div className="flex items-start gap-3">
                     <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shadow-[0_0_10px_orange]" />
      ...
      {/* RESULT / TESTIMONIALS */}
      <section id="risultati" className="py-24 bg-brand-dark relative overflow-hidden">
         {/* Background Glow */}
      ...
      {/* CHI SIAMO SECTION */}
      <section id="chi-siamo" className="py-24 bg-brand-dark/50 relative">
         <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
               ...
               <br/><br/>
               Il nostro obiettivo è uno solo: <span className="text-brand-red font-bold">riempire il tuo locale</span>.
               Niente vanity metrics, solo clienti veri che pagano.
            </p>
         </div>
      </section>
      ...
      <section id="faq" className="py-24 relative overflow-hidden">
         <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="space-y-4">
               ...
               <details className="group bg-brand-gray/30 border border-white/5 rounded-2xl open:bg-brand-gray/50 open:border-brand-red/20 transition-all duration-300">
                  <summary className="flex items-center justify-between cursor-pointer p-6 list-none font-bold text-lg text-white">
                     <span>Lavorate solo con ristoranti?</span>
                     <span className="transform group-open:rotate-180 transition-transform text-brand-gold">▼</span>
                  </summary>
                  <div className="px-6 pb-6 text-gray-400">
                     Sì, siamo specializzati verticalmente nel settore food & beverage. Conosciamo le dinamiche del tuo mercato meglio di chiunque altro.
                  </div>
               </details>
               ...
               <details className="group bg-brand-gray/30 border border-white/5 rounded-2xl open:bg-brand-gray/50 open:border-brand-red/20 transition-all duration-300">
                  <summary className="flex items-center justify-between cursor-pointer p-6 list-none font-bold text-lg text-white">
                     <span>Devo per forza fare video su TikTok?</span>
                     <span className="transform group-open:rotate-180 transition-transform text-brand-gold">▼</span>
                  </summary>
                  <div className="px-6 pb-6 text-gray-400">
                     Assolutamente no. Il nostro metodo si basa su strategie che portano risultati indipendentemente dal fatto che tu voglia "metterci la faccia" o meno.
                  </div>
               </details>
            </div>
         </div>
